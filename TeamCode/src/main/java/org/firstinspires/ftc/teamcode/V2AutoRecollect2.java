...
@Autonomous(name="V2AutoRecollect2", group="OpMode")
@Disabled

public class V2AutoRecollect2 extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        while (opModeIsActive()) {
            ...
            //*hopefully* when glyph is jammed the code above while stop and restart the intake to unjam it
*/
...
//****************CASES BEGIN HERE CASES BEGIN HERE CASES BEGIN HERE*****************************
            ...
            switch(case_switch){
                ...
                case 8:
                    ...
                    if(touch.getState() || touch2.getState()){
                        Drive(-0.55);
                        sleep(350);
                        Drive(0);
                        runtime.reset();
                ...
                case 9:
                    ...
                    else if((touchcount2 > 1 && !pressed2) || finished){
                        Drive(0);
                        runtime.reset();
                        intakeL.setPower(0);
                        intakeR.setPower(0);
                ...
                case 204:
                    ...
                    if(intaketimer.seconds() > 2.75){
                        depright.setPower(0);
                        depleft.setPower(0);
                    }

                    driveToTarget(encoderTarget, -0.8, -0.2);
                ...
                case 205:
                    ...
                    encoderTarget = -350;
                    driveToTarget(encoderTarget, -0.25, -0.2);
                ...
                case 212:
                    ...
                    driveToTarget(encoderTarget, -0.2, -0.05);
...
//BLUE POS 2 BLUE POS 2 BLUE POS 2
                ...
                case 321:
                    ...
                    ScurveMed(1800, -0.9, 20, startpos);
                    if(currentpos < 1800 + 20){
                        Drive(0);
                        resetDriveEncoders();
                        intakeL.setPower(0);
